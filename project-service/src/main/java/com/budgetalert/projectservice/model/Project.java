...
@Entity @Table(name="projects") @Getter @Setter @NoArgsConstructor @AllArgsConstructor @Builder
public class Project {
 ...
 @Column(nullable=false) private Double monthlyBudget;
 ...
 @Builder.Default private List<ProjectResource> resources = new ArrayList<>();
}